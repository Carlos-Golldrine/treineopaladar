...
- **Manifest:** 5334 URLs únicas (`data/imagens_manifest.csv`); 52 URLs duplicadas entre linhas removidas no dedup de URL.
- Extensões inferidas: {'jpg': 3739, 'png': 1141, 'webp': 454} (URLs VTEX sem extensão recebem default `jpg`; o downloader corrige pelo content-type).
