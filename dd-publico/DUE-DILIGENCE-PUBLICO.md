...
### A1. Idade 35-54: NÃO REFUTADA (sem poder estatístico para chamar de sustentada)
...
- **Leitura cruzada (corrigida pela verificação adversarial)**: a única perna auditável (IG, n=57) tem p=0,500 num teste sem poder; o IC [36,6; 61,7] é compatível com a tese E com a antítese. Os cadastros n=148 são agregado declarado em documento, sem microdado no acervo (não verificáveis). O centro 35-54 é plausível e não foi refutado, com cauda 25-34 relevante. Confiança: baixa-média; quem fecha a questão é o dado declarado do beta (E1).
...
|---|---|---|---|
| Núcleo etário 35-54 | Não refutado | Baixa-média | cadastros n=148 (agregado não auditável) + [DADO proxy] IG n=57 sem poder |
...
- [DADO] A dor do iniciante é SILENCIOSA: comentário com dúvida recebe MENOS like (rho = menos 0,126, p-FDR=0,002; efeito pequeno, r2 de ~1,6%). Implicação direcional [HIPOTESE de mídia]: conteúdo "aprenda comigo" tende a engajar menos; alcance orgânico tende a vir do entendido performando e do desafio. Por isso a dor silenciosa se mede por clique e conversão, nunca por like.
- [DADO proxy, codificador único] A audiência pede mecânica de jogo aos criadores: 13 a 18/264 comentários YT (13 reproduzíveis por regex independente) pedem teste cego, ranking, adivinhar preço ("Erraste lindamente!" [YT238]; "errar faz parte" [YT236]). Iniciante e entendido convivem no mesmo jogo [YT214].
...
| IA como argumento de venda ("a IA sabe mais que você") | Hostilidade do segmento entendido/criador, que é o candidato a motor de distribuição | [HIPOTESE de risco, ancorada em dado mínimo] 4 a 6 menções explícitas a IA no Reddit (corpus anglófono), todas hostis ("Clanker", "AI slop", "Go away" [RD022, RD448, RD450, RD533]); o restante da categoria original era "atalhos de tecnologia", não IA. Para BR: zero ocorrências no corpus pt, risco latente | Média-alta pelo custo assimétrico (mudar o pitch é grátis, perder criadores é caro). Vender como TREINO, nunca como IA. Ver correção C5 |
...
- **Aquisição (LPs, anúncios, conteúdo)**: dois flights separados. Flight ACOLHIMENTO+ASPIRAÇÃO para iniciante (dor silenciosa: ela não engaja, mas clica; medir CTR e D1, não like). Flight DESAFIO para entendido (ele engaja em like; o share é a hipótese central a medir via grade compartilhada e tráfego indireto). [HIPOTESE: o A/B do beta arbitra o mix, ver E4]
...
- Evidência: [DADO] OR 1,71 de engajamento do entendido (like, não share; share é hipótese a medir); [DADO proxy] 13-18/264 pedidos de teste cego; [DADO] bios IG: ~1 em 5 comentadores ativos já é semi-profissional (13-15/64 com credencial WSET/sommelier) e a gamificação JÁ existe no nicho ("@mestre_dos_vinhos", "1° @vivino blind tasting") = demanda e concorrência informal.
...
- Evidência: [HIPOTESE de risco, dado mínimo] 4 a 6 menções explícitas a IA no Reddit anglófono, todas hostis ("Clanker", "AI slop"); [DADO] o valor percebido do vinho para o entendido é o percurso sem atalho ("Aprendi o ofício marca a marca; garrafa a garrafa" [S2073, 15 likes]). [HIPOTESE: no corpus pt a rejeição ainda não aparece; o risco é com criadores e parceiros, exatamente o canal de distribuição].
...
- Evidência: [DADO proxy, codificador único; regex independente reproduz contagens menores] suave vs seco é o tema nº 1 em volume do corpus iniciante (~40-82/676 conforme o rigor do dicionário); há vergonha documentada de gostar de suave [S2442, 18 likes] e gatekeeping dos dois lados [S2576, S2579]; [DADO] demanda por informação de doçura no rótulo ("A Evino deveria informar no app/site se o vinho é seco, meio seco ou doce/suave" [S2417, 15 likes]).
...
- Evidência: [DADO, frase corrigida pela verificação] dos 118 comentários TikTok pt do corpus, 29 mencionam Malbec; 7 têm referência textual ao perfume Malbec do Boticário e o vínculo dos demais é inferência de contexto dos vídeos; a menção de maior like de todo o corpus (10.467) está nesse grupo.
...
- **Dor/desejo na língua do público**: "Continuo achando que uma tasting às cegas de teroldego e Marselan nacionais pode ser uma boa" [YT157] · "não existe nada mais performático do que entender coisas sobre vinhos" [S2626, 1.304 likes] · "I would bet money if you served it blind a lot of people here would get it wrong" [RD392] · [DADO proxy] 13-18/264 pedidos de mecânica de desafio; [DADO] OR 1,71 de engajamento (like) do entendido.
- **Promessa (headlines candidatas)**:
